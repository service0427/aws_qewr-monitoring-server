...
## Agent Installation
Agents are installed on remote nodes via a single command. The script enforces the `U26-??` hostname policy, auto-installs Tailscale, and configures a cron job.
...
## Repositories
- **Main App:** `https://github.com/service0427/aws_qewr-monitoring-server`
- **Installer Script:** `https://github.com/service0427/init`
